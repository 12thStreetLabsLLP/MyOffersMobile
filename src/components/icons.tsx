...
export const ArrowIosBackIcon = (style: ImageStyle): IconElement => (
  <Icon fill="#FFF" {...style} name="arrow-ios-back" />
);
...
export const RadiusIcon = (style: ImageStyle): IconElement => (
  <Icon fill="#ffffff" {...style} name="pin-outline" />
);
...
export const MenuIcon = (style: ImageStyle): IconElement => (
  <Icon fill="#ffffff" {...style} name="menu" />
);
...
export const TrendingIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name="trending-up-outline" />
);

export const UserAddIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name="person-add-outline" />
);

export const UserUpdateIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name="person-outline" />
);

export const DownwardArrow = (style: ImageStyle): IconElement => (
  <Icon fill="#FFF" {...style} name="arrow-ios-downward-outline" />
);
